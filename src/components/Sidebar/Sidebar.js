...
import avatar from "assets/img/tt_avatar_small.jpg";
...
class Sidebar extends React.Component {
  ...
  createLinks = routes => {
    const { classes, color, rtlActive, isActive } = this.props;
    return routes.map((prop, key) => {
      ...
      const allowToClick = isActive ? (isActive === 'ACTIVE') : false;
        ...
        >
          <NavLink
            ...
            className={cx(
              ...
              { [classes.disableMenu] : prop.requiredSubscription ? !allowToClick : false}
            )}
          >
            {prop.icon !== undefined ? (
              typeof prop.icon === "string" ? (
...
const matchStateToEventProps = state => {
  return {
    ...
    userPlan: state.userReducer.plan,
    isActive: state.userReducer.isActive
  };
};

const sidebarWithStyle = withStyles(sidebarStyle)(Sidebar);
const SidebarRedux = connect(matchStateToEventProps)(sidebarWithStyle);
